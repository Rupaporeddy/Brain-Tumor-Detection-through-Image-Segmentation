...
%% Display Together
figure
subplot(231);imshow(s);title('Input image','FontSize',15);
subplot(232);imshow(inp);title('Filtered image','FontSize',15);
subplot(233);imshow(inp);title('Bounding Box','FontSize',15);
hold on;rectangle('Position',wantedBox,'EdgeColor','y');hold off;
subplot(234);imshow(tumor);title('tumor alone','FontSize',15);
subplot(235);imshow(tumorOutline);title('Tumor Outline','FontSize',15);
subplot(236);imshow(tumorOutlineInserted);title('Detected Tumor','FontSize',15);